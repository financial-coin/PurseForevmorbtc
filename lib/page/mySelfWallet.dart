...
class MySelfWallet extends StatefulWidget {
  @override
  // ignore: library_private_types_in_public_api
  _MySelfWalletPageState createState() => _MySelfWalletPageState();
}

class _MySelfWalletPageState extends State<MySelfWallet> {
