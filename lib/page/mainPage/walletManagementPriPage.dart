...
class WalletManagementPriPage extends StatefulWidget {
  @override
  _WalletManagementPriPageState createState() =>
      _WalletManagementPriPageState();
}

class _WalletManagementPriPageState extends State<WalletManagementPriPage> {
  ...
  void initState() {
    super.initState();
    var currentNetwork1 = Get.arguments["currentNetwork"];
    var account1 = Get.arguments["account"];
    setState(() {
      currentNetwork = currentNetwork1;
      account = account1;
    });
    _loadWalletData();
  }
